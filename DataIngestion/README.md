...
That's [a harmless issue with the Zookeeper](https://issues.apache.org/jira/browse/ZOOKEEPER-2795) (according to developers, the log level should have been WARN instead of ERROR).

I'm using [scalatest-embedded-kafka](https://github.com/manub/scalatest-embedded-kafka) to create unit tests for the Kafka producer.
...
For my own future reference, [here are the ports used by the services]([Cloudera VM Ports](https://www.cloudera.com/documentation/enterprise/5-2-x/topics/cdh_ig_ports_cdh5.html).
